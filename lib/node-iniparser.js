		...
		if(regex.comment.test(line)){
			...
			if(section){
				if(value[section][match[1]]) {
					if(!(value[section][match[1]] instanceof Array)){
						value[section][match[1]] = new Array(value[section][match[1]]);
					}
				...
				if(value[match[1]]) {
					if(!(value[match[1]] instanceof Array)){
						value[match[1]] = new Array(value[match[1]]);
					}
